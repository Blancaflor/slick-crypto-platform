   ...
   {/*<Link to="/page-2/">Watch the Video</Link>*/}
    ...
    <div className="Cards2">
      ...
      <div className="CardGroup">
        <a>
        <Card 
         title="Launch of Landing Page"
         text="(Q3)"
         image={require('../images/golden-honey2.png')} />
        </a>
        <a>
        <Card 
         title="Launch of Social Media Channels"
         text="(Q4)"
         image={require('../images/golden-honey2.png')} />
        </a>
        <a>
        <Card 
         title="Launch of Market Place"
         text="(Q4)"
         image={require('../images/golden-honey2.png')} />
        </a>
        <a>
        ...
        <a>
        <Card 
         title="Slick Initial DEX Offer"
         text="(Q4)"
         image={require('../images/golden-honey2.png')} />
        </a>
        <a>
        <Card 
         title="Launch Marketplace V1"
         text="(Q4)"
         image={require('../images/golden-honey2.png')} />
        </a>
        <a>
        <Card 
         title="Launch of Stakingplatform"
         text="(Q4)"
         image={require('../images/golden-honey2.png')} />
        </a>
        <a>
        <Card 
         title="First smart NFTs: Badger - Honey Pot"
         text="(Q4)"
         image={require('../images/golden-honey2.png')} />
        </a>
      </div>
